...
export const BOT = "BirthdayReminderProBot";
...
export const HUB_FALLBACK = "https://t.me/TinyTelegramToolsBot/birthday";
...
/** Product title shown in the Mini App header and share-widget label (intel/hub-apps.json). */
export const TITLE = "Birthday Reminders";
